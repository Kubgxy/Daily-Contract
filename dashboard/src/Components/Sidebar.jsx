            ...
            <div className="mt-6 space-y-1">
              ...
              <button
                ...
                className={`sidebar-item w-full text-left ${
                  isActive("/employees") || isActive("/workrecord")
                    ? "active"
                    : ""
                }`}
              >
              ...
              {openEmployees && (
                <div className="pl-2 space-y-1 animate-fade-in">
                  ...
                  <a
                    ...
                    className={`sidebar-item-nested ${
                      isActive("/renewal-requests") ? "active" : ""
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                ...
                className={`sidebar-item ${
                  isActive("/checkin-history") ? "active" : ""
                }`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {openRequests && (
                <div className="pl-2 space-y-1 animate-fade-in">
                  ...
                  <a
                    href="/leave-requests"
                    className={`sidebar-item-nested ${
                      isActive("/leave-requests") ? "active" : ""
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    ...
                    className={`sidebar-item-nested ${
                      isActive("/attendance-requests") ? "active" : ""
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
